...
## Overview
Transform the rewards app to match Thanx brand identity by creating a centralized theme system using CSS custom properties and updating all components to use Thanx colors, typography, and design patterns.
...
Create `web/src/components/branding/ThanxLogo.tsx` as an SVG-based component displaying "Thanx" wordmark in teal (#11C0BF).
...
- Visual verification at http://localhost:3000
