...
Add user authentication infrastructure and display current user's points balance.
Backend-first approach: User model with database constraints, API endpoint with
Alba serialization, then React frontend with Redux state management.
